...
/*
  Additional code to convert HTML to Markdown for forms.
  Courtesy of http://scito.ch/content/html-markdown-converter-using-regex
  http://scito.ch/sites/scito.ch/files/static/regexhtml2md/regexhtml2md.js?v=1.1
*/
...
var HtmlToMarkdown = (function () {
  ...
  var ignore_BR = false,
  convertBlockquote = function (str) {
    var r = str;
  ...
  blockquoteNestingDetector = function (match, p1, p2, offset, string) {
  ...
  ulOlNestingDetector = function (match, p1, p2, offset, string) {
